...
（→ `rules/model/art-of-subtraction.md` の Artifact surface: deletion judgment 節。L1 Model Layer に統合済 (#1351)）
...
| Deletion Impact | `rules/model/art-of-subtraction.md` (Artifact surface) | L1 | rules/ 常時 (#1351 で統合) |
