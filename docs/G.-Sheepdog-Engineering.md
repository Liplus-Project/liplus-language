...
`rules/model/minus-aesthetic.md` の **「Defaults for all Li+ source」(rebuild allowed, deletion allowed, optimization allowed. Structure must remain coherent.)** は、この原則の literal である。
