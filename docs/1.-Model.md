...
> Source: `rules/model/minus-aesthetic.md` (Output surface 節、#1351 で統合済)
...
> Source: `rules/model/minus-aesthetic.md` (Output surface 節「One-step and two-step responses remain valid when sufficient」、#1351 で統合済)
