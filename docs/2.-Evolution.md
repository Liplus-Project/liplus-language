...
| `rules/evolution/initiator-autonomy.md` | 自己進化ループ initiator 権限（AI 側）の詳細 scope。self-evolution PR 定義 / 二段ブレーキ（brake1 = parallel-agent-eval N≥3 / brake2 = L1 root-criteria evaluator）/ recovery 軸 |
