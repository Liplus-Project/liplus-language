...
L1 brake 2 override (orthogonal axis, supersedes per-PR exception):
  ...
  What counts as touching L1, mixed-PR handling, the evaluator's identity, and
  the PASS-substitutes-human-approval semantic are specified in
  `rules/evolution/initiator-autonomy.md` Two-stage brake. Do not restate them
  here; the second copy is what drifts.
