...
> Source: `skills/agentic-search/SKILL.md` (skill)
> 注: `model-agentic-search` / `model-web-search-judgment` / `task-research-strategy` / `task-retrieval-orchestration` の 4 skill は #1380 で `skills/agentic-search/` に統合済。
