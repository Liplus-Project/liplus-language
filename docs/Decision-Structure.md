...
| [`decision-structure-industry-positioning`](https://github.com/Liplus-Project/liplus-language/wiki/decision-structure-industry-positioning) | 判断構造の industry 既存 vocabulary 上の位置取り — ARCHITECTURE.md (matklad 2021) 哲学を decision domain に graph 構造として拡張、ADR variant ではない |
