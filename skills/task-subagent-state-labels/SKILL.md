...
- Role completion (implementation phase finished, orchestration awaited) → switch `in-progress` → `review-pending` immediately before reporting to parent and exiting.
