...
- Auto-mode classifier rejection of unbounded `rm [A-Z]*.md ...` patterns is structural (`rules/model/minus-aesthetic.md` Artifact surface blast-radius axis), not a transient block. Diff-targeted copy aligns with that axis by construction.
