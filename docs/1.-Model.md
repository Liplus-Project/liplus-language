...
> Source: `skills/model-expansion-limit/SKILL.md`
...
> Source: `skills/model-output-density/SKILL.md`
...
> Source: `skills/model-output-density/SKILL.md` (Lower bound permission 節として吸収済)
