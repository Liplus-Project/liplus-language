...
- **brake 1 (always)**: every self-evolution PR runs `skills/evolution-parallel-agent-eval` before the commit/merge gate. N=1 self-check is prohibited; minimum N=3.
