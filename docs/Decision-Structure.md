...
| [`neuron-graph-rag-integrated-prototype`](https://github.com/Liplus-Project/liplus-language/wiki/neuron-graph-rag-integrated-prototype) | Prototype dense and sparse retrieval, a typed knowledge graph, activation propagation, and success feedback as one independent RAG engine before considering integration into Li+. |
